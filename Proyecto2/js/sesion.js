...
function login(){		
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if(this.responseText==="FALSE"){
                ...
                //Esto debería mostrar la página
                ...
                cargarCategorias(); //Aquí se llama a cargarCategorías(), que no lo veía			
            }
        }
    }
    ...
    xhttp.open("POST", "login_json.php", true); //Esto prepara para enviar el usuario y la contraseña por POST	
